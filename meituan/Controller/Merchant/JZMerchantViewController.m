...
-(void)getMerchantList{
    ...
    NSString *urlStr = [NSString stringWithFormat:@"%@%f%@%f&offset=%zd%@",str1, locationManager.latitude, str, locationManager.longitude, _offset,str2];
